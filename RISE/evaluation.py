...
class CausalMetric():
    ...
    def single_run(self, img_tensor, explanation, verbose=0, save_to=None, save_last=False):
        ...
        """
        HW = explanation.shape[2]*explanation.shape[3]
        ...
        for i in range(n_steps+1):
            ...
            if (verbose == 2 or (verbose == 1 and i == n_steps) or (save_to is not None) ) & (((save_last is True) & (i==n_steps)) | (save_last is False)):
